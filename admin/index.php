...
<body>
	<div class="login-page bk-img" style="background-image: url(img/background.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
				<img src="logo.png" alt="Logo" height="15%" width="35%" class="img-responsive center-block d-block mx-auto"/>     
					<div class="col-md-6 col-md-offset-3">
					<h4 class="text-center text-bold mt-3x">Welcome to S. S. Agrawal College </h4>
						<h1 class="text-center text-bold mt-4x text-primary">Admin Login</h1>
