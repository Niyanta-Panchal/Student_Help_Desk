...
if(isset($_POST['submit']))
  {
	...
	$sql="UPDATE register SET enroll=(:enroll), name=(:name), collegename=(:collegename), dept=(:dept), email=(:email), gender=(:gender), Image=(:image) WHERE id=(:idedit)";
...
<div class="col-sm-4">
<input type="text" name="enroll" class="form-control" required value="<?php echo htmlentities($result->enroll);?>">
</div>
...
<div class="col-sm-4">
<input type="text" name="collegename" class="form-control" required value="<?php echo htmlentities($result->collegename);?>">
</div>
</div>

<label class="col-sm-2 control-label">Department<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="dept" class="form-control" required value="<?php echo htmlentities($result->dept);?>">
</div>
</div>
