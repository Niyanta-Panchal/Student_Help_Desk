...
<?php $sql = "SELECT * from  bonafide where course='SSAIET'";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										<tr>
											...
											<span class="glyphicon glyphicon-download-alt"></span><a href="pdfcreater.php?id=<?php echo htmlentities($result->id);?>">&nbsp;&nbsp;Download Bonafide</a></button>
											</div>   
											</td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
