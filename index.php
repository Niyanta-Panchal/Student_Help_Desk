...
$sql ="SELECT email,password FROM register WHERE email=:email and password=:password and status=(:status)";
...
echo "<script type='text/javascript'> document.location = 'bonafide.php'; </script>";
} else{
